...
bot.on('message', async (msg) => {
  ...
  if (msg.text === 'Завершить переход🔱') {
    try {
      ...
      if (res.data.success) {
        // Приветствие и reply-кнопка "Групписо призывус! 📜"
      ...
      await bot.sendMessage(msg.chat.id, "Что-то пошло не так с магическим сервером. Попробуй чуть позже или напиши в поддержку!", {
  ...
  if (msg.text === 'Групписо призывус! 📜') {
    ...
    // Дальше можешь отправлять список групп или следующую логику!
    return;
  }
